...
export class CreatePriceListDto {
  ...
  @ApiPropertyOptional({ description: 'Status', enum: PRICE_LIST_STATUS, example: 'active' })
  @IsOptional()
  ...
  @ApiPropertyOptional({ description: 'Stop after first match (when evaluating rows)', example: true })
  @IsOptional()
  @IsBoolean()
