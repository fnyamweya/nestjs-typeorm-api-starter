...
import { ConditionOperator, PromotionActionType, PromotionConditionType, PromotionStatus, StackingPolicy } from '../entities/promotion.enums';
...
export class CreatePromotionDto {
  ...
  @ApiPropertyOptional({ description: 'Optional metadata blob (admin-only)', example: { note: 'created by ops' } })
  @IsOptional()
  @IsObject()
  ...
  @ApiPropertyOptional({
    ...
    isArray: true,
    description: 'All conditions must match (logical AND). Omit or pass [] for unconditional promotions.',
  })
  @IsOptional()
  @IsArray()
  ...
  @ApiProperty({
    ...
    isArray: true,
    description: 'Actions to apply when conditions match. At least one action is required.',
  })
  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => CreatePromotionActionDto)
